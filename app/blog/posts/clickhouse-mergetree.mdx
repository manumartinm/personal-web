...
After studying these papers and working with ClickHouse in production, I built my own minimal implementation with the help of Claude Code. I’ll start with the key design decisions, and then connect them to the full write/read/merge flow.
...
Chang, F., Dean, J., Ghemawat, S., Hsieh, W. C., Wallach, D. A., Burrows, M., Chandra, T., Fikes, A., & Gruber, R. E. (2006). [_Bigtable: A distributed storage system for structured data_](https://static.googleusercontent.com/media/research.google.com/en//archive/bigtable-osdi06.pdf).
